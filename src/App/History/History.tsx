...
function History() {
    return <div className="History">
        <div className="title-view">
            ...
            <div className="title">
                History of the Better Living Health Center
            </div>
        </div>
        {historyText}
        <div className="line" />
...
const historyText = <div className="text-holder">
    ...
    <p>
        It was in April 1998 that the doors of the Better Living Health Centre opened to the public. It was a dream come true and was long overdue for its two partner owners: Dr. Idamae Hanna and Dr. Alvira Higgs. From 1989 they were in partnership presenting health programs to the church and the community, working as Lifestyle Counselors from Uchee Pines Lifestyle Institute. The Better Living Health Center is an institution that is a pioneer in wellness coordination and consultation in The Bahamas.
    </p>
    <p>
        Better Living has the island's best vegetarian cuisine, serving only vegetarian meals that empower people to eat better. It also houses the island's best in natural foods and supplements and it is the island's best consultants in lifestyle, health & wellness. The center has a registered dietitian who provides individualized or group wellness plans for major chronic diseases such as diabetes, hypertension and cancer. The center also provides corporate and worksite wellness seminars and programs and is one of the founders of the popular 8 Weeks to Wellness community program that has impacted the health of thousands of Bahamians throughout the Bahamas.
    </p>
    <MissionBoxes />
    <p>
        According to Dr. Idamae Hanna, “When we first opened the doors of Better Living, we served only soups and sandwiches. We also started with a few organic products and supplements on our shelves, and I set up my office to do private consultations as a registered dietitian. As I remember, the first six months were slow, and we couldn’t pay ourselves a salary because everything had to go into paying rent and sustaining our budding business. It wasn’t until six months later that we paid ourselves a stipend of $50.00 each week. Wow, just thinking about it now is amazing. We were truly sustained by the power of God.”
    </p>
    <p>
        It was about three months after we started that we were inspired by a program on Three ABN Broadcasting network. The person on the set was giving her testimony of how she started a business similar to Better Living and how she got her product and her business marketed to the community. She was able to advertise by giving. What a great biblical concept - being able to receive by giving. She decided to do a free health expo at a mall in her community, and in doing this, the community got to know about her business and the wonderful health information and products she had to offer. From then her business bloomed.
    </p>
