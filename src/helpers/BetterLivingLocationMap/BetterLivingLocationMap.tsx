...
import backToCenterIcon from '../../HomePage/AppAndMapSection/back-to-center-icon';
    ...
    useEffect(() => {
        ...
        function displayMapOnScreen() {
            ...
            const map = new mapboxgl.Map({
                container: mapDivID,
                style: 'https://api.mapbox.com/styles/v1/patrickhanna242/ckjkp1aqh05851ao9nc42wvtr.html?fresh=true&title=view&access_token=pk.eyJ1IjoicGF0cmlja2hhbm5hMjQyIiwiYSI6ImNqcnh2eWVrczBydGo0OWx2dDUyYjhvNnMifQ.SGbGDXppFmFkdUnBxIyoqA',
